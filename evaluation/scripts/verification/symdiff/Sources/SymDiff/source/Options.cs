...
namespace SDiff
{
    public static class Options
    {
        ...
        public static HashSet<string> forceCheckProcs = new HashSet<string>();
        ...
        public static string GetBoogieOptions()
        {
            ...
            boogieOptions += " -typeEncoding:p -timeLimit:" + Options.Timeout + " -removeEmptyBlocks:0  " + Options.BoogieUserOpts;
            if (Options.DoSymEx)
