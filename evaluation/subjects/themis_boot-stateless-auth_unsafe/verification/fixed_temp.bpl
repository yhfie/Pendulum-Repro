...
procedure {:prefix "fixed"} fixed.TokenHandler$$la$clinit$ra$$() returns ($exception: ref);
  modifies fixed.com.jdriven.stateless.security.User$TokenHandler$VALID_USER263, fixed.$objIndex, fixed.$heap;
...
implementation fixed.TokenHandler$$la$clinit$ra$$() returns ($exception: ref)
{
  var $r2: ref;
  var $fakelocal_1: ref;
  var $l0: int;
