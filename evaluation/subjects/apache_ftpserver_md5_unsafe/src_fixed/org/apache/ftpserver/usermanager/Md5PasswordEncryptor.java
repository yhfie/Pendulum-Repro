...
public class Md5PasswordEncryptor implements PasswordEncryptor {
    ...
    public boolean regionMatches(String thisValue, boolean ignoreCase, int toffset, String other, int ooffset,
        ...
        while (len-- > 0) {
            char c1 = ta[to++];
            char c2 = pa[po++];
            boolean _b3250 = Safe.eq(c1, c2);
            boolean _continue3250 = false;
            _continue3250 = Safe.cond(_b3250, true, _continue3250);
            ...
            if (ignoreCase) {
                ...
                boolean _b3694 = Safe.eq(u1, u2);
                boolean _continue3694 = false;
                _continue3694 = Safe.cond(_b3694, true, _continue3694);
