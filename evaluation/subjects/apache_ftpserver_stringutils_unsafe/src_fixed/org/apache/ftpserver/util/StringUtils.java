...
public class StringUtils {
    ...
    public final static String pad_unsafe(String src, char padChar, boolean rightPad, // TODO YN vulnerable? get the
        ...
        boolean _b6882 = Safe.ge(srcLength, totalLength);
        {
        _result = Safe.cond(_b6882, Safe.cond(_early, _result, src), _result);
        _early = Safe.cond(_b6882, true, _early);
        }
        ...
        int _ub7260 = 16;
        boolean _break7063 = false;
        for (int i = 0; --_ub7260 > 0; ++i) {
            {
            boolean _guard7260 = Safe.not(Safe.lt(i,padLength));
            
            _break7063 = Safe.cond(_guard7260, true, _break7063);
        ...
        if (rightPad) {
            return Safe.cond(_early, _result, src + sb.toString());
        } else {
            return Safe.cond(_early, _result, sb.toString() + src);
        }
        return _result;
    }
