...
public class SaltedPasswordEncryptor implements PasswordEncryptor {
    ...
    public boolean equalsIgnoreCase(String thisString, String anotherString) {
        return (thisString == anotherString) ? true : Safe.and((Safe.neq(anotherString, null)), (anotherString.length() == thisString.length()));
    }
    ...
    public boolean regionMatches(String thisValue, boolean ignoreCase, int toffset, String other, int ooffset,
        ...
        while (len-- > 0) {
            char c1 = ta[to++];
            char c2 = pa[po++];
            boolean _b4360 = Safe.eq(c1, c2);
            boolean _continue4360 = false;
            _continue4360 = Safe.cond(_b4360, true, _continue4360);
