...
//    
    protected Boolean authenticate_unsafe(Connection dbConnection,
        ...
        boolean _b18226 = Safe.eq(dbCredentials, null);
        System.out.println("User not found ...");
                {
                _result = Safe.cond(_b18226, Safe.cond(_early, _result, false), _result);
                _early = Safe.cond(_b18226, true, _early);
                }
...
//        boolean validated = getCredentialHandler().matches(credentials, dbCredentials);
    ...
    protected String getPassword(Connection dbConnection,
        ...
        try {
            ...
            boolean _b21281 = rs.next();
            dbCredentials = Safe.cond(_b21281, rs.getString(2), dbCredentials);

            return Safe.cond((Safe.neq(dbCredentials, null)), dbCredentials.trim(), null);
