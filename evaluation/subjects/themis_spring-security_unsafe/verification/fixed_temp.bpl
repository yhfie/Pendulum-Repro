...
procedure {:prefix "fixed"} fixed.java.lang.StringBuilder$$la$init$ra$$($this: ref) returns ($exception: ref);
  modifies fixed.$objIndex, fixed.$arrSizeHeap, fixed.$heap;
...
procedure {:prefix "fixed"} fixed.java.lang.String$$la$init$ra$$char$lp$$rp$($this: ref, $in_parameter__0: ref) returns ($exception: ref);
  modifies fixed.$objIndex, fixed.$arrSizeHeap, fixed.$heap, fixed.$intArrHeap;
...
procedure {:prefix "fixed"} fixed.java.lang.String$format$java.lang.String_java.lang.Object$lp$$rp$($in_parameter__0: ref, $in_parameter__1: ref)
   returns ($return: ref, $exception: ref);
...
implementation fixed.java.lang.String$format$java.lang.String_java.lang.Object$lp$$rp$($in_parameter__0: ref, $in_parameter__1: ref)
   returns ($return: ref, $exception: ref)
{
  var r0: ref;
  var r1: ref;
