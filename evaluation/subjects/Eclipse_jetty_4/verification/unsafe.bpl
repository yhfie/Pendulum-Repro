   ...
   returns ($return: int, $exception: ref)
{
  ...
  block17:
    call $return, $exception, $z1, $c4, $fakelocal_0, $i2, $c3, i5, z0 := Credential$stringEquals_original$java.lang.String_java.lang.String_loop_block17($return, $exception, $z1, r1, i0, $c4, $fakelocal_0, $i2, $c3, i5, z0, i1, r0);
    goto block17_last;
...
implementation Credential$stringEquals_original$java.lang.String_java.lang.String_loop_block17(in_$return: int, 
    in_$exception: ref, 
    in_$z1: int, 
    in_r1: ref, 
    in_i0: int, 
    ...
    out_z0: int)
{
  ...
  block20_dummy:
    call {:si_unique_call 1} out_$return, out_$exception, out_$z1, out_$c4, out_$fakelocal_0, out_$i2, out_$c3, out_i5, out_z0 := Credential$stringEquals_original$java.lang.String_java.lang.String_loop_block17(out_$return, out_$exception, out_$z1, in_r1, in_i0, out_$c4, out_$fakelocal_0, out_$i2, out_$c3, out_i5, out_z0, in_i1, in_r0);
    return;
...
procedure Credential$stringEquals_original$java.lang.String_java.lang.String_loop_block17(in_$return: int, 
    in_$exception: ref, 
    in_$z1: int, 
    in_r1: ref, 
    in_i0: int, 
