...
procedure PROC_.Credential$$la$init$ra$$_EQ_unsafe__xx__fixed($this: ref) returns (AA_TEMP330: bool);
  modifies Output_of_unsafe.Credential$$la$init$ra$$_$exception, Output_of_fixed.Credential$$la$init$ra$$_$exception;
  ensures AA_TEMP330;



implementation PROC_.Credential$$la$init$ra$$_EQ_unsafe__xx__fixed($this: ref) returns (AA_TEMP330: bool)
{
  var AA_TEMP320: ref;
  var $exception: ref;
  ...
  AA_INSTR_EQ_BODY$2:
    Output_of_unsafe.Credential$$la$init$ra$$_$exception := AA_TEMP320;
    Output_of_fixed.Credential$$la$init$ra$$_$exception := $exception;
    havoc AA_TEMP330;
    AA_TEMP330 := AA_TEMP330 || AA_TEMP320 == $exception;
    return;
}
