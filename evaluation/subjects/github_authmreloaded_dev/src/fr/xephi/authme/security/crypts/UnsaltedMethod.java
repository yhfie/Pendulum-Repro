...
public abstract class UnsaltedMethod implements EncryptionMethod {
    ...
    /* developer fix */
	/* changed second argument type, for the test suite to compile */
    public static boolean /*isEqual_safe*/isEqual_unsafe(String string1, /*String*/Object string2) {
		if (string2 instanceof String) {
			return MessageDigestisEqual(string1.getBytes(StandardCharsets.UTF_8),
					((String)string2).getBytes(StandardCharsets.UTF_8));
		}
		return false;
    }
