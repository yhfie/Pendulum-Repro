   ...
   returns ($return: int, $exception: ref)
{
  ...
  block19:
    call $return, $exception, $i6, i9, i8, $fakelocal_2, i10, $i7, $fakelocal_1, $fakelocal_3, i12, $fakelocal_0 := modpow.SimplifiedRSA$modPowFastKocherReduction$int_int_int_int_loop_block19($return, $exception, $i6, i9, i8, $fakelocal_2, i3, i10, $i7, $fakelocal_1, i1, $fakelocal_3, i12, $fakelocal_0);
    goto block19_last;
    ...
    out_$fakelocal_0: ref)
{
  ...
  anon21_dummy:
    call {:si_unique_call 1} out_$return, out_$exception, out_$i6, out_i9, out_i8, out_$fakelocal_2, out_i10, out_$i7, out_$fakelocal_1, out_$fakelocal_3, out_i12, out_$fakelocal_0 := modpow.SimplifiedRSA$modPowFastKocherReduction$int_int_int_int_loop_block19(out_$return, out_$exception, out_$i6, out_i9, out_i8, out_$fakelocal_2, in_i3, out_i10, out_$i7, out_$fakelocal_1, in_i1, out_$fakelocal_3, out_i12, out_$fakelocal_0);
    return;
