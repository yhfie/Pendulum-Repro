...
//const { :sourceloc "Aes256Cryptor.java",-1,-1,-1,-1 } unique java.lang.Boolean : javaType extends  unique java.lang.Object, java.io.Serializable, java.lang.Comparable complete;
...
procedure $new(obj_type:javaType) returns ($obj:ref);    modifies $objIndex, $heap;    ensures !old($heap[$obj,$alloc]);    ensures $obj != $null;    ensures $heap == old($heap)[$obj,$alloc := true][$obj,$type := obj_type];    ensures $obj == $intToRef(old($objIndex));    ensures $objIndex == old($objIndex) + 1;
...
procedure org.cryptomator.crypto.aes256.Aes256Cryptor$1$$la$init$ra$$org.cryptomator.crypto.aes256.Aes256Cryptor($this:ref, $in_parameter__0:ref) returns ($exception:ref);    modifies $heap;

procedure java.lang.Object$$la$init$ra$$($this:ref) returns ($exception:ref);    

procedure org.cryptomator.crypto.aes256.Aes256Cryptor$1$accept$java.nio.file.Path($this:ref, $in_parameter__0:ref) returns ($return:int, $exception:ref);    modifies $objIndex, $heap;

procedure java.nio.file.PathMatcher$matches$java.nio.file.Path($this:ref, $in_parameter__0:ref) returns ($return:int, $exception:ref);    modifies $heap;

procedure org.cryptomator.crypto.aes256.Aes256Cryptor$1$accept$java.lang.Object($this:ref, $in_parameter__0:ref) returns ($return:int, $exception:ref);    modifies $objIndex, $heap;

procedure org.cryptomator.crypto.aes256.Aes256Cryptor$$la$init$ra$$($this:ref) returns ($exception:ref);    modifies $objIndex, $arrSizeHeap, $heap;
...
procedure org.cryptomator.crypto.aes256.Aes256Cryptor$$la$init$ra$$java.util.Random($this:ref, $in_parameter__0:ref) returns ($exception:ref);    modifies $objIndex, $arrSizeHeap, $heap;

procedure java.util.Random$nextBytes$byte$lp$$rp$($this:ref, $in_parameter__0:ref) returns ($exception:ref);    

procedure org.cryptomator.crypto.aes256.Aes256Cryptor$encryptMasterKey$java.io.OutputStream_java.lang.CharSequence($this:ref, $in_parameter__0:ref, $in_parameter__1:ref) returns ($exception:ref);    modifies $objIndex, $arrSizeHeap, $heap;

procedure org.cryptomator.crypto.aes256.Aes256Cryptor$randomData$int($this:ref, $in_parameter__0:int) returns ($return:ref, $exception:ref);    modifies $objIndex, $arrSizeHeap, $heap;

procedure org.cryptomator.crypto.aes256.Aes256Cryptor$scrypt$java.lang.CharSequence_byte$lp$$rp$_int_int_int($this:ref, $in_parameter__0:ref, $in_parameter__1:ref, $in_parameter__2:int, $in_parameter__3:int, $in_parameter__4:int) returns ($return:ref, $exception:ref);    modifies $objIndex, $heap;

procedure org.cryptomator.crypto.aes256.Aes256Cryptor$aesKeyWrapCipher$javax.crypto.SecretKey_int($this:ref, $in_parameter__0:ref, $in_parameter__1:int) returns ($return:ref, $exception:ref);    modifies $objIndex, $heap;
...
procedure com.fasterxml.jackson.databind.ObjectMapper$writeValue$java.io.OutputStream_java.lang.Object($this:ref, $in_parameter__0:ref, $in_parameter__1:ref) returns ($exception:ref);    
...
procedure org.cryptomator.crypto.aes256.Aes256Cryptor$decryptMasterKey$java.io.InputStream_java.lang.CharSequence($this:ref, $in_parameter__0:ref, $in_parameter__1:ref) returns ($exception:ref);    modifies $objIndex, $heap;

procedure com.fasterxml.jackson.databind.ObjectMapper$readValue$java.io.InputStream_java.lang.Class($this:ref, $in_parameter__0:ref, $in_parameter__1:ref) returns ($return:ref, $exception:ref);    
...
procedure org.cryptomator.crypto.exceptions.UnsupportedKeyLengthException$$la$init$ra$$int_int($this:ref, $in_parameter__0:int, $in_parameter__1:int) returns ($exception:ref);    
...
procedure javax.crypto.Cipher$unwrap$byte$lp$$rp$_java.lang.String_int($this:ref, $in_parameter__0:ref, $in_parameter__1:ref, $in_parameter__2:int) returns ($return:ref, $exception:ref);    
...
procedure org.cryptomator.crypto.aes256.Aes256Cryptor$swipeSensitiveDataInternal$($this:ref) returns ($exception:ref);    modifies $objIndex, $heap;

procedure org.cryptomator.crypto.aes256.Aes256Cryptor$destroyQuietly$javax.security.auth.Destroyable($this:ref, $in_parameter__0:ref) returns ($exception:ref);    modifies $objIndex, $heap;
...
procedure javax.crypto.Cipher$init$int_java.security.Key($this:ref, $in_parameter__0:int, $in_parameter__1:ref) returns ($exception:ref);    

procedure java.lang.IllegalArgumentException$$la$init$ra$$java.lang.String_java.lang.Throwable($this:ref, $in_parameter__0:ref, $in_parameter__1:ref) returns ($exception:ref);    

procedure org.cryptomator.crypto.aes256.Aes256Cryptor$aesCtrCipher$javax.crypto.SecretKey_byte$lp$$rp$_int($this:ref, $in_parameter__0:ref, $in_parameter__1:ref, $in_parameter__2:int) returns ($return:ref, $exception:ref);    modifies $objIndex, $heap;
...
procedure org.cryptomator.crypto.aes256.Aes256Cryptor$aesEcbCipher$javax.crypto.SecretKey_int($this:ref, $in_parameter__0:ref, $in_parameter__1:int) returns ($return:ref, $exception:ref);    modifies $objIndex, $heap;

procedure java.lang.AssertionError$$la$init$ra$$java.lang.String_java.lang.Throwable($this:ref, $in_parameter__0:ref, $in_parameter__1:ref) returns ($exception:ref);    

procedure org.cryptomator.crypto.aes256.Aes256Cryptor$hmacSha256$javax.crypto.SecretKey($this:ref, $in_parameter__0:ref) returns ($return:ref, $exception:ref);    modifies $objIndex, $heap;
...
procedure org.bouncycastle.crypto.generators.SCrypt$generate$byte$lp$$rp$_byte$lp$$rp$_int_int_int_int($in_parameter__0:ref, $in_parameter__1:ref, $in_parameter__2:int, $in_parameter__3:int, $in_parameter__4:int, $in_parameter__5:int) returns ($return:ref, $exception:ref);    

procedure java.lang.CharSequence$length$($this:ref) returns ($return:int, $exception:ref);    modifies $heap;

procedure java.lang.StringBuilder$setCharAt$int_char($this:ref, $in_parameter__0:int, $in_parameter__1:int) returns ($exception:ref);    

procedure org.cryptomator.crypto.aes256.Aes256Cryptor$crc32Sum$byte$lp$$rp$($this:ref, $in_parameter__0:ref) returns ($return:int, $exception:ref);    modifies $objIndex, $heap;
...
procedure org.cryptomator.crypto.aes256.Aes256Cryptor$encryptPath$java.lang.String_char_char_org.cryptomator.crypto.CryptorIOSupport($this:ref, $in_parameter__0:ref, $in_parameter__1:int, $in_parameter__2:int, $in_parameter__3:ref) returns ($return:ref, $exception:ref);    modifies $objIndex, $heap, $stringSizeHeap;

procedure org.apache.commons.lang3.StringUtils$split$java.lang.String_char($in_parameter__0:ref, $in_parameter__1:int) returns ($return:ref, $exception:ref);    

procedure java.util.ArrayList$$la$init$ra$$int($this:ref, $in_parameter__0:int) returns ($exception:ref);    

procedure org.cryptomator.crypto.aes256.Aes256Cryptor$encryptPathComponent$java.lang.String_javax.crypto.SecretKey_org.cryptomator.crypto.CryptorIOSupport($this:ref, $in_parameter__0:ref, $in_parameter__1:ref, $in_parameter__2:ref) returns ($return:ref, $exception:ref);    modifies $objIndex, $heap, $stringSizeHeap;

procedure java.util.List$add$java.lang.Object($this:ref, $in_parameter__0:ref) returns ($return:int, $exception:ref);    modifies $heap;

procedure org.apache.commons.lang3.StringUtils$join$java.lang.Iterable_char($in_parameter__0:ref, $in_parameter__1:int) returns ($return:ref, $exception:ref);    
...
procedure org.apache.commons.lang3.ArrayUtils$subarray$byte$lp$$rp$_int_int($in_parameter__0:ref, $in_parameter__1:int, $in_parameter__2:int) returns ($return:ref, $exception:ref);    
...
procedure org.cryptomator.crypto.aes256.Aes256Cryptor$getMetadata$org.cryptomator.crypto.CryptorIOSupport_java.lang.String($this:ref, $in_parameter__0:ref, $in_parameter__1:ref) returns ($return:ref, $exception:ref);    modifies $objIndex, $heap;
...
procedure org.cryptomator.crypto.aes256.Aes256Cryptor$storeMetadata$org.cryptomator.crypto.CryptorIOSupport_java.lang.String_org.cryptomator.crypto.aes256.LongFilenameMetadata($this:ref, $in_parameter__0:ref, $in_parameter__1:ref, $in_parameter__2:ref) returns ($exception:ref);    modifies $objIndex, $heap;

procedure org.cryptomator.crypto.aes256.Aes256Cryptor$decryptPath$java.lang.String_char_char_org.cryptomator.crypto.CryptorIOSupport($this:ref, $in_parameter__0:ref, $in_parameter__1:int, $in_parameter__2:int, $in_parameter__3:ref) returns ($return:ref, $exception:ref);    modifies $objIndex, $heap;

procedure org.cryptomator.crypto.aes256.Aes256Cryptor$decryptPathComponent$java.lang.String_javax.crypto.SecretKey_org.cryptomator.crypto.CryptorIOSupport($this:ref, $in_parameter__0:ref, $in_parameter__1:ref, $in_parameter__2:ref) returns ($return:ref, $exception:ref);    modifies $objIndex, $heap;
...
procedure org.apache.commons.lang3.StringUtils$removeEnd$java.lang.String_java.lang.String($in_parameter__0:ref, $in_parameter__1:ref) returns ($return:ref, $exception:ref);    

procedure org.apache.commons.lang3.StringUtils$substringBefore$java.lang.String_java.lang.String($in_parameter__0:ref, $in_parameter__1:ref) returns ($return:ref, $exception:ref);    

procedure org.apache.commons.lang3.StringUtils$substringAfter$java.lang.String_java.lang.String($in_parameter__0:ref, $in_parameter__1:ref) returns ($return:ref, $exception:ref);    
...
procedure org.apache.commons.lang3.StringUtils$removeEndIgnoreCase$java.lang.String_java.lang.String($in_parameter__0:ref, $in_parameter__1:ref) returns ($return:ref, $exception:ref);    
...
procedure com.fasterxml.jackson.databind.ObjectMapper$readValue$byte$lp$$rp$_java.lang.Class($this:ref, $in_parameter__0:ref, $in_parameter__1:ref) returns ($return:ref, $exception:ref);    
...
procedure org.cryptomator.crypto.CryptorIOSupport$writePathSpecificMetadata$java.lang.String_byte$lp$$rp$($this:ref, $in_parameter__0:ref, $in_parameter__1:ref) returns ($exception:ref);    
...
procedure org.cryptomator.crypto.aes256.Aes256Cryptor$authenticateContent_unsafe$java.nio.channels.SeekableByteChannel($this:ref, $in_parameter__0:ref) returns ($return:int, $exception:ref);    modifies $objIndex, $heap;

procedure org.cryptomator.crypto.aes256.Aes256Cryptor$decryptedContentLength$java.nio.channels.SeekableByteChannel($this:ref, $in_parameter__0:ref) returns ($return:ref, $exception:ref);    modifies $objIndex, $heap;

procedure java.nio.channels.SeekableByteChannel$position$long($this:ref, $in_parameter__0:int) returns ($return:ref, $exception:ref);    modifies $heap;

procedure javax.crypto.Mac$getMacLength$($this:ref) returns ($return:int, $exception:ref);    

procedure java.nio.channels.SeekableByteChannel$read$java.nio.ByteBuffer($this:ref, $in_parameter__0:ref) returns ($return:int, $exception:ref);    modifies $heap;
...
procedure org.cryptomator.crypto.aes256.MacInputStream$$la$init$ra$$java.io.InputStream_javax.crypto.Mac($this:ref, $in_parameter__0:ref, $in_parameter__1:ref) returns ($exception:ref);    
...
procedure org.apache.commons.io.IOUtils$copyLarge$java.io.InputStream_java.io.OutputStream_long_long($in_parameter__0:ref, $in_parameter__1:ref, $in_parameter__2:int, $in_parameter__3:int) returns ($return:int, $exception:ref);    

procedure javax.crypto.Mac$doFinal$($this:ref) returns ($return:ref, $exception:ref);    

procedure org.cryptomator.crypto.aes256.Aes256Cryptor$jdkArraysEquals$byte$lp$$rp$_byte$lp$$rp$($in_parameter__0:ref, $in_parameter__1:ref) returns ($return:int, $exception:ref);    modifies $objIndex, $heap;
...
procedure java.nio.ByteBuffer$getLong$($this:ref) returns ($return:int, $exception:ref);    modifies $heap;
...
procedure org.cryptomator.crypto.aes256.Aes256Cryptor$decryptedFile$java.nio.channels.SeekableByteChannel_java.io.OutputStream($this:ref, $in_parameter__0:ref, $in_parameter__1:ref) returns ($return:ref, $exception:ref);    modifies $objIndex, $heap;

procedure javax.crypto.CipherInputStream$$la$init$ra$$java.io.InputStream_javax.crypto.Cipher($this:ref, $in_parameter__0:ref, $in_parameter__1:ref) returns ($exception:ref);    

procedure org.cryptomator.crypto.aes256.Aes256Cryptor$decryptRange$java.nio.channels.SeekableByteChannel_java.io.OutputStream_long_long($this:ref, $in_parameter__0:ref, $in_parameter__1:ref, $in_parameter__2:int, $in_parameter__3:int) returns ($return:ref, $exception:ref);    modifies $objIndex, $heap;

procedure java.nio.ByteBuffer$putLong$int_long($this:ref, $in_parameter__0:int, $in_parameter__1:int) returns ($return:ref, $exception:ref);    modifies $heap;

procedure org.cryptomator.crypto.aes256.Aes256Cryptor$encryptFile$java.io.InputStream_java.nio.channels.SeekableByteChannel($this:ref, $in_parameter__0:ref, $in_parameter__1:ref) returns ($return:ref, $exception:ref);    modifies $objIndex, $arrSizeHeap, $heap;

procedure java.nio.channels.SeekableByteChannel$truncate$long($this:ref, $in_parameter__0:int) returns ($return:ref, $exception:ref);    modifies $heap;

procedure java.nio.Buffer$position$int($this:ref, $in_parameter__0:int) returns ($return:ref, $exception:ref);    

procedure java.nio.channels.SeekableByteChannel$write$java.nio.ByteBuffer($this:ref, $in_parameter__0:ref) returns ($return:int, $exception:ref);    modifies $heap;
...
procedure org.cryptomator.crypto.aes256.MacOutputStream$$la$init$ra$$java.io.OutputStream_javax.crypto.Mac($this:ref, $in_parameter__0:ref, $in_parameter__1:ref) returns ($exception:ref);    

procedure javax.crypto.CipherOutputStream$$la$init$ra$$java.io.OutputStream_javax.crypto.Cipher($this:ref, $in_parameter__0:ref, $in_parameter__1:ref) returns ($exception:ref);    

procedure org.apache.commons.io.IOUtils$copyLarge$java.io.InputStream_java.io.OutputStream($in_parameter__0:ref, $in_parameter__1:ref) returns ($return:int, $exception:ref);    
...
procedure java.nio.ByteBuffer$putLong$long($this:ref, $in_parameter__0:int) returns ($return:ref, $exception:ref);    modifies $heap;

procedure org.cryptomator.crypto.aes256.Aes256Cryptor$getPayloadFilesFilter$($this:ref) returns ($return:ref, $exception:ref);    modifies $objIndex, $heap;

procedure org.cryptomator.crypto.aes256.Aes256Cryptor$$la$clinit$ra$$() returns ($exception:ref);    modifies int$org.cryptomator.crypto.aes256.Aes256Cryptor$AES_KEY_LENGTH_IN_BITS0, $objIndex, java.security.SecureRandom$org.cryptomator.crypto.aes256.Aes256Cryptor$SECURE_PRNG260, $heap;
...
var r0 : ref;
    ...
    r1 := $in_parameter__0;
    assert { :sourceloc "Aes256Cryptor.java",637,-1,-1,-1 } true;
    if ($heap[r1,$type] <: java.nio.file.Path) {
        $exception := $exception;
    } else {
...
implementation org.cryptomator.crypto.aes256.Aes256Cryptor$encryptMasterKey$java.io.OutputStream_java.lang.CharSequence($this:ref, $in_parameter__0:ref, $in_parameter__1:ref) returns ($exception:ref){
...
implementation org.cryptomator.crypto.aes256.Aes256Cryptor$decryptMasterKey$java.io.InputStream_java.lang.CharSequence($this:ref, $in_parameter__0:ref, $in_parameter__1:ref) returns ($exception:ref){
...
var $fakelocal_1 : ref;
  ...
  block19:
    ...
    assert { :sourceloc "Aes256Cryptor.java",183,-1,-1,-1 } true;
    if ($heap[$r8,$type] <: org.cryptomator.crypto.aes256.KeyFile) {
        $exception := $exception;
    } else {
  ...
  block21:
    ...
    assert { :sourceloc "Aes256Cryptor.java",196,-1,-1,-1 } true;
    if ($heap[$r11,$type] <: javax.crypto.SecretKey) {
        $exception := $exception;
    } else {
    ...
    assert { :sourceloc "Aes256Cryptor.java",197,-1,-1,-1 } true;
    if ($heap[$r13,$type] <: javax.crypto.SecretKey) {
        $exception := $exception;
    } else {
  ...
  block22:
    ...
    $r15 := $exception;
    assert { :sourceloc "Aes256Cryptor.java",205,-1,-1,-1 } true;
    call $fakelocal_9 := $new(org.cryptomator.crypto.exceptions.WrongPasswordException);
    r24 := $fakelocal_9;
    assert { :sourceloc "Aes256Cryptor.java",205,-1,-1,-1 } true;
    call $exception := org.cryptomator.crypto.exceptions.WrongPasswordException$$la$init$ra$$(r24);
    assert { :sourceloc "Aes256Cryptor.java",-1,-1,-1,-1 } true;
    if ($heap[r24,$type] <: java.lang.Throwable) {
        $exception := $exception;
    } else {
...
var $fakelocal_0 : ref;
  ...
  block27:
    ...
    if ($exception != $null) {
        if ($heap[$exception,$type] <: javax.security.auth.DestroyFailedException) {
            goto block28;
        } else {
            assert { :clone } true;
        }
...
implementation org.cryptomator.crypto.aes256.Aes256Cryptor$aesKeyWrapCipher$javax.crypto.SecretKey_int($this:ref, $in_parameter__0:ref, $in_parameter__1:int) returns ($return:ref, $exception:ref){
...
implementation org.cryptomator.crypto.aes256.Aes256Cryptor$aesCtrCipher$javax.crypto.SecretKey_byte$lp$$rp$_int($this:ref, $in_parameter__0:ref, $in_parameter__1:ref, $in_parameter__2:int) returns ($return:ref, $exception:ref){
...
implementation org.cryptomator.crypto.aes256.Aes256Cryptor$aesEcbCipher$javax.crypto.SecretKey_int($this:ref, $in_parameter__0:ref, $in_parameter__1:int) returns ($return:ref, $exception:ref){
...
implementation org.cryptomator.crypto.aes256.Aes256Cryptor$scrypt$java.lang.CharSequence_byte$lp$$rp$_int_int_int($this:ref, $in_parameter__0:ref, $in_parameter__1:ref, $in_parameter__2:int, $in_parameter__3:int, $in_parameter__4:int) returns ($return:ref, $exception:ref){
...
implementation org.cryptomator.crypto.aes256.Aes256Cryptor$encryptPath$java.lang.String_char_char_org.cryptomator.crypto.CryptorIOSupport($this:ref, $in_parameter__0:ref, $in_parameter__1:int, $in_parameter__2:int, $in_parameter__3:ref) returns ($return:ref, $exception:ref){
...
var $r8 : ref;
  ...
  block63:
    ...
    if ($exception != $null) {
        if ($heap[$exception,$type] <: javax.crypto.IllegalBlockSizeException) {
            assert { :clone } true;
            goto block64;
        } else {
            assert { :clone } true;
...
implementation org.cryptomator.crypto.aes256.Aes256Cryptor$encryptPathComponent$java.lang.String_javax.crypto.SecretKey_org.cryptomator.crypto.CryptorIOSupport($this:ref, $in_parameter__0:ref, $in_parameter__1:ref, $in_parameter__2:ref) returns ($return:ref, $exception:ref){
...
implementation org.cryptomator.crypto.aes256.Aes256Cryptor$decryptPath$java.lang.String_char_char_org.cryptomator.crypto.CryptorIOSupport($this:ref, $in_parameter__0:ref, $in_parameter__1:int, $in_parameter__2:int, $in_parameter__3:ref) returns ($return:ref, $exception:ref){
...
implementation org.cryptomator.crypto.aes256.Aes256Cryptor$decryptPathComponent$java.lang.String_javax.crypto.SecretKey_org.cryptomator.crypto.CryptorIOSupport($this:ref, $in_parameter__0:ref, $in_parameter__1:ref, $in_parameter__2:ref) returns ($return:ref, $exception:ref){
...
implementation org.cryptomator.crypto.aes256.Aes256Cryptor$getMetadata$org.cryptomator.crypto.CryptorIOSupport_java.lang.String($this:ref, $in_parameter__0:ref, $in_parameter__1:ref) returns ($return:ref, $exception:ref){
...
var $fakelocal_1 : ref;
  ...
  block81:
    ...
    assert { :sourceloc "Aes256Cryptor.java",402,-1,-1,-1 } true;
    if ($heap[$r5,$type] <: org.cryptomator.crypto.aes256.LongFilenameMetadata) {
        $exception := $exception;
    } else {
...
implementation org.cryptomator.crypto.aes256.Aes256Cryptor$storeMetadata$org.cryptomator.crypto.CryptorIOSupport_java.lang.String_org.cryptomator.crypto.aes256.LongFilenameMetadata($this:ref, $in_parameter__0:ref, $in_parameter__1:ref, $in_parameter__2:ref) returns ($exception:ref){
...
var $fakelocal_0 : ref;
    ...
    assume { :sourceloc "Aes256Cryptor.java",-1,-1,-1,-1 } $heap[$this,$type] <: org.cryptomator.crypto.aes256.Aes256Cryptor;
    assume { :sourceloc "Aes256Cryptor.java",-1,-1,-1,-1 } $this != $null;
    assume $heap[$in_parameter__2,$type] <: org.cryptomator.crypto.aes256.LongFilenameMetadata;
    assume $heap[$in_parameter__0,$type] <: org.cryptomator.crypto.CryptorIOSupport;
    assume $heap[$in_parameter__1,$type] <: java.lang.String;
    $exception := $null;
    assert { :sourceloc "Aes256Cryptor.java",-1,-1,-1,-1 } true;
...
var $fakelocal_10 : ref;
  ...
  block86:
    ...
    r18 := $fakelocal_6;
    assert { :sourceloc "Aes256Cryptor.java",-1,-1,-1,-1 } true;
    if ($heap[r5,$type] <: java.io.InputStream) {
        $exception := $exception;
    } else {
        call $fakelocal_7 := $new(java.lang.ClassCastException);
        $return := 0;
    ...
    assert { :sourceloc "Aes256Cryptor.java",-1,-1,-1,-1 } true;
    if ($heap[r6,$type] <: java.io.InputStream) {
        $exception := $exception;
    } else {
    ...
    r21 := r6;
    assert { :sourceloc "Aes256Cryptor.java",-1,-1,-1,-1 } true;
    if ($heap[r19,$type] <: java.io.OutputStream) {
        $exception := $exception;
    } else {
        call $fakelocal_10 := $new(java.lang.ClassCastException);
        $return := 0;
...
implementation org.cryptomator.crypto.aes256.Aes256Cryptor$jdkArraysEquals$byte$lp$$rp$_byte$lp$$rp$($in_parameter__0:ref, $in_parameter__1:ref) returns ($return:int, $exception:ref){
...
implementation org.cryptomator.crypto.aes256.Aes256Cryptor$decryptedFile$java.nio.channels.SeekableByteChannel_java.io.OutputStream($this:ref, $in_parameter__0:ref, $in_parameter__1:ref) returns ($return:ref, $exception:ref){
...
implementation org.cryptomator.crypto.aes256.Aes256Cryptor$decryptRange$java.nio.channels.SeekableByteChannel_java.io.OutputStream_long_long($this:ref, $in_parameter__0:ref, $in_parameter__1:ref, $in_parameter__2:int, $in_parameter__3:int) returns ($return:ref, $exception:ref){
...
implementation org.cryptomator.crypto.aes256.Aes256Cryptor$encryptFile$java.io.InputStream_java.nio.channels.SeekableByteChannel($this:ref, $in_parameter__0:ref, $in_parameter__1:ref) returns ($return:ref, $exception:ref){
...
var r5 : ref;
    ...
    r41 := $fakelocal_10;
    assert { :sourceloc "Aes256Cryptor.java",-1,-1,-1,-1 } true;
    if ($heap[r8,$type] <: java.io.OutputStream) {
        $exception := $exception;
    } else {
    ...
    r42 := $fakelocal_12;
    assert { :sourceloc "Aes256Cryptor.java",-1,-1,-1,-1 } true;
    if ($heap[r9,$type] <: java.io.OutputStream) {
        $exception := $exception;
    } else {
