...
implementation org.cryptomator.crypto.aes256.Aes256Cryptor$hmacSha256$javax.crypto.SecretKey($this: ref, $in_parameter__0: ref) returns ($return: ref, $exception: ref)
{
  ...
  block49:
    ...
    $r3 := $fakelocal_2;
    assert {:sourceloc "Aes256Cryptor.java", 264, -1, -1, -1} true;
    call $exception := java.lang.IllegalArgumentException$$la$init$ra$$java.lang.String_java.lang.Throwable($r3, $StringConst12, r8);
    assert {:sourceloc "Aes256Cryptor.java", 264, -1, -1, -1} true;
    $exception := $r3;
    goto block51;
  ...
  block48:
    ...
    $r5 := $fakelocal_1;
    assert {:sourceloc "Aes256Cryptor.java", 262, -1, -1, -1} true;
    call $exception := java.lang.AssertionError$$la$init$ra$$java.lang.String_java.lang.Throwable($r5, $StringConst11, r7);
    assert {:sourceloc "Aes256Cryptor.java", 262, -1, -1, -1} true;
    $exception := $r5;
    goto block51;
}
   ...
   returns ($return: ref, $exception: ref)
{
  ...
  block59:
    call $exception, $i5, i7 := org.cryptomator.crypto.aes256.Aes256Cryptor$scrypt$java.lang.CharSequence_byte$lp$$rp$_int_int_int_loop_block59($exception, r3, r1, $i5, i7);
    goto block59_last;
  ...
  block56:
    call $return, $exception, i6, $i4, $fakelocal_3 := org.cryptomator.crypto.aes256.Aes256Cryptor$scrypt$java.lang.CharSequence_byte$lp$$rp$_int_int_int_loop_block56($return, $exception, i6, $i4, r3, r1, $fakelocal_3);
    goto block56_last;
   ...
   returns ($return: ref, $exception: ref)
{
  ...
  block65:
    call $return, $exception, r6, i4, $fakelocal_4, $r9, r5, $fakelocal_3 := org.cryptomator.crypto.aes256.Aes256Cryptor$encryptPath$java.lang.String_char_char_org.cryptomator.crypto.CryptorIOSupport_loop_block65($return, $exception, r6, r3, i4, $fakelocal_4, $r9, r4, r5, $fakelocal_3, i2, r0, r2);
    goto block65_last;
   ...
   returns ($return: ref, $exception: ref)
{
  ...
  block73:
    call $return, $exception, i4, $r9, r6, $fakelocal_3, $fakelocal_4, $r10, r5, $fakelocal_5 := org.cryptomator.crypto.aes256.Aes256Cryptor$decryptPath$java.lang.String_char_char_org.cryptomator.crypto.CryptorIOSupport_loop_block73($return, $exception, i4, r2, $r9, r6, r4, $fakelocal_3, r0, i2, $fakelocal_4, $r10, r5, $fakelocal_5, r3);
    goto block73_last;
   ...
   returns ($return: int, $exception: ref)
{
  ...
  block92:
    call $return, $exception, $b2, $fakelocal_3, i4, $fakelocal_2, $b3 := org.cryptomator.crypto.aes256.Aes256Cryptor$jdkArraysEquals$byte$lp$$rp$_byte$lp$$rp$_loop_block92($return, $exception, i0, $b2, $fakelocal_3, r0, i4, $fakelocal_2, r1, $b3);
    goto block92_last;
   ...
   returns ($return: ref, $exception: ref)
{
  ...
  block105:
    call $return, $exception, i10 := org.cryptomator.crypto.aes256.Aes256Cryptor$encryptFile$java.io.InputStream_java.nio.channels.SeekableByteChannel_loop_block105($return, $exception, i10, r12, r10, i0);
    goto block105_last;
...
implementation org.cryptomator.crypto.aes256.Aes256Cryptor$scrypt$java.lang.CharSequence_byte$lp$$rp$_int_int_int_loop_block59(in_$exception: ref, in_r3: ref, in_r1: ref, in_$i5: int, in_i7: int)
   returns (out_$exception: ref, out_$i5: int, out_i7: int)
{
  ...
  anon23_dummy:
    call {:si_unique_call 1} out_$exception, out_$i5, out_i7 := org.cryptomator.crypto.aes256.Aes256Cryptor$scrypt$java.lang.CharSequence_byte$lp$$rp$_int_int_int_loop_block59(out_$exception, in_r3, in_r1, out_$i5, out_i7);
    return;
...
procedure org.cryptomator.crypto.aes256.Aes256Cryptor$scrypt$java.lang.CharSequence_byte$lp$$rp$_int_int_int_loop_block59(in_$exception: ref, in_r3: ref, in_r1: ref, in_$i5: int, in_i7: int)
   returns (out_$exception: ref, out_$i5: int, out_i7: int);
  modifies $heap;
    ...
    out_$fakelocal_3: ref)
{
  ...
  anon20_dummy:
    call {:si_unique_call 1} out_$return, out_$exception, out_i6, out_$i4, out_$fakelocal_3 := org.cryptomator.crypto.aes256.Aes256Cryptor$scrypt$java.lang.CharSequence_byte$lp$$rp$_int_int_int_loop_block56(out_$return, out_$exception, out_i6, out_$i4, in_r3, in_r1, out_$fakelocal_3);
    return;
    ...
    out_$fakelocal_3: ref)
{
  ...
  anon28_dummy:
    call {:si_unique_call 1} out_$return, out_$exception, out_r6, out_i4, out_$fakelocal_4, out_$r9, out_r5, out_$fakelocal_3 := org.cryptomator.crypto.aes256.Aes256Cryptor$encryptPath$java.lang.String_char_char_org.cryptomator.crypto.CryptorIOSupport_loop_block65(out_$return, out_$exception, out_r6, in_r3, out_i4, out_$fakelocal_4, out_$r9, in_r4, out_r5, out_$fakelocal_3, in_i2, in_r0, in_r2);
    return;
    ...
    out_$fakelocal_5: int)
{
  ...
  anon32_dummy:
    call {:si_unique_call 1} out_$return, out_$exception, out_i4, out_$r9, out_r6, out_$fakelocal_3, out_$fakelocal_4, out_$r10, out_r5, out_$fakelocal_5 := org.cryptomator.crypto.aes256.Aes256Cryptor$decryptPath$java.lang.String_char_char_org.cryptomator.crypto.CryptorIOSupport_loop_block73(out_$return, out_$exception, out_i4, in_r2, out_$r9, out_r6, in_r4, out_$fakelocal_3, in_r0, in_i2, out_$fakelocal_4, out_$r10, out_r5, out_$fakelocal_5, in_r3);
    return;
    ...
    out_$b3: int)
{
  ...
  block94_dummy:
    call {:si_unique_call 1} out_$return, out_$exception, out_$b2, out_$fakelocal_3, out_i4, out_$fakelocal_2, out_$b3 := org.cryptomator.crypto.aes256.Aes256Cryptor$jdkArraysEquals$byte$lp$$rp$_byte$lp$$rp$_loop_block92(out_$return, out_$exception, in_i0, out_$b2, out_$fakelocal_3, in_r0, out_i4, out_$fakelocal_2, in_r1, out_$b3);
    return;
...
implementation org.cryptomator.crypto.aes256.Aes256Cryptor$encryptFile$java.io.InputStream_java.nio.channels.SeekableByteChannel_loop_block105(in_$return: ref, 
    in_$exception: ref, 
    in_i10: int, 
    in_r12: ref, 
    in_r10: ref, 
   ...
   returns (out_$return: ref, out_$exception: ref, out_i10: int)
{
  ...
  anon48_dummy:
    call {:si_unique_call 1} out_$return, out_$exception, out_i10 := org.cryptomator.crypto.aes256.Aes256Cryptor$encryptFile$java.io.InputStream_java.nio.channels.SeekableByteChannel_loop_block105(out_$return, out_$exception, out_i10, in_r12, in_r10, in_i0);
    return;
...
procedure org.cryptomator.crypto.aes256.Aes256Cryptor$encryptFile$java.io.InputStream_java.nio.channels.SeekableByteChannel_loop_block105(in_$return: ref, 
    in_$exception: ref, 
    in_i10: int, 
    in_r12: ref, 
    in_r10: ref, 
