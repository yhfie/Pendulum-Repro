...
public class Driver_Greedy {
    ...
    public static void main(String[] args) {
        ...
        /* WARNING: this driver does not make any sense; the sole purpose is to
         * inform DifFuzzAR of the method to be repaired.
         */
        Mem.clear();
        boolean result1 = Credential.stringEquals_original(s1.get(0), s2);

        Mem.clear();
        boolean result2 = Credential.stringEquals_original(s1.get(1), s2);
