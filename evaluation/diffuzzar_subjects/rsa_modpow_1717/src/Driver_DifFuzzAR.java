...
public class Driver_Greedy {
	...
	public static void main(String[] args) {
		...
		Mem.clear();
		SimplifiedRSA.modPowFastKocherReduction(base_public, exponent_secrets[0], modulus_fixed, MAX_HIGH);
		Mem.clear();
		SimplifiedRSA.modPowFastKocherReduction(base_public, exponent_secrets[1], modulus_fixed, MAX_HIGH);
