...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        boolean valid1 = encrMethod.comparePassword(storedPassword_valid_secret1.getHash(), encrMethod.computeHash(password_public));
        ...
        boolean valid2 = encrMethod.comparePassword(storedPassword_invalid_secret2.getHash(), encrMethod.computeHash(password_public));
