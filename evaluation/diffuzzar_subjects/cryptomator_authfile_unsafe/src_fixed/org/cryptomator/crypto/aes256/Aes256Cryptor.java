...
public class Aes256Cryptor extends AbstractCryptor implements AesCryptographicConfiguration , FileNamingConventions {
    ...
    @Override
    public void decryptMasterKey(InputStream in, CharSequence password) throws IOException, DecryptFailedException, UnsupportedKeyLengthException, WrongPasswordException {
        try {
    ...
    private String encryptPathComponent(final String cleartext, final SecretKey key, CryptorIOSupport ioSupport) throws IOException, BadPaddingException, IllegalBlockSizeException {
    ...
    private String decryptPathComponent(final String encrypted, final SecretKey key, CryptorIOSupport ioSupport) throws IOException, BadPaddingException, IllegalBlockSizeException {
    ...
    public boolean authenticateContent_unsafe$Old(SeekableByteChannel encryptedFile) throws IOException {
