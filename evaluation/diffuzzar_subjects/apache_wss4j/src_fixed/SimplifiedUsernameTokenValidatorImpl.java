...
public class SimplifiedUsernameTokenValidatorImpl {
    ...
    public static void verifyPlaintextPassword$Old(PasswordString passwordType, String dBPassword) throws WSSecurityException {
    ...
    public static void verifyPlaintextPassword(PasswordString passwordType, String dBPassword) throws WSSecurityException {
        if (!unsafe_String_equals(passwordType.getValue(), dBPassword)) {
            throw new WSSecurityException(WSSecurityException.FAILED_AUTHENTICATION);
        }
        passwordType.setValue(dBPassword);
