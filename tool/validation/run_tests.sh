...
# all subjects that have a test suite
declare -a subjects=(
...
echo "Running regression tests on subjects"
echo "----------"
...
do
  ...
  java -cp "../../../tool/validation/lib/*:../../../tool/validation/bin:evosuite-tests-bin:bin:lib/*" Runtest $testclass
