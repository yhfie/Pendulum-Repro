...
public class OSecurityManager {
  ...
  public boolean equals_inline(String iPassword, String iHash) {
    ...
    if (n == iHash.length()) {
      ...
      int i = 0;
      while (n-- != 0) {
        boolean _b4205 = Safe.neq(v1[i], v2[i]);
        _result = Safe.cond(_b4205, Safe.cond(_early, _result, false), _result);
        _early = Safe.cond(_b4205, true, _early);
  ...
  private byte[] getPbkdf2(
    ...
    try {
      ...
      throw OException.wrapException(
          new OSecurityException("Cannot create a key with '" + PBKDF2_ALGORITHM + "' algorithm"),
          e);
    }
  }
